...
Similar to the primary incubation step. The secondary is raised agains the primary's species (eg. goat (<- secondary's host species) anti-rabbit (<- primary's host species)) and carries a fluorophore. Fluorophores photobleach, so this step is done in the dark to preserve signal. 
